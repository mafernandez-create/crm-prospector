 ...
 * Devuelven una cadena HTML para inyectar en el DOM con .innerHTML.
 * Se exponen como window.Icon.<name>(size?, extraAttrs?).
 */
(function () {
  'use strict';

  const icon = (path, attrs = '') =>
    `<svg class="icon" viewBox="0 0 24 24" ${attrs}>${path}</svg>`;
  ...
  const Icon = {
    ...
    Building: () => icon(
      '<rect x="4" y="3" width="16" height="18" rx="1.5"/><line x1="9" y1="8" x2="9" y2="8"/><line x1="15" y1="8" x2="15" y2="8"/><line x1="9" y1="12" x2="9" y2="12"/><line x1="15" y1="12" x2="15" y2="12"/><line x1="9" y1="16" x2="15" y2="16"/>'
    ),
    FileText: () => icon(
    ...
    Edit: () => icon(
      '<path d="M3 21l3-1 12-12-2-2L4 18z"/><path d="M14 6l4 4"/>'
    ),
    Check: () => icon(
    ...
    X: () => icon('<line x1="6" y1="6" x2="18" y2="18"/><line x1="18" y1="6" x2="6" y2="18"/>'),
    Target: () => icon(
      '<circle cx="12" cy="12" r="9"/><circle cx="12" cy="12" r="5"/><circle cx="12" cy="12" r="1.5"/>'
    ),
    AlertTriangle: () => icon(
      '<path d="M12 3l10 18H2L12 3z"/><line x1="12" y1="10" x2="12" y2="14"/><line x1="12" y1="17.5" x2="12" y2="17.6"/>'
    ),
    Home: () => icon('<path d="M3 11.5L12 4l9 7.5V20a1 1 0 0 1-1 1h-5v-7h-6v7H4a1 1 0 0 1-1-1z"/>'),
    Briefcase: () => icon(
      '<rect x="3" y="7" width="18" height="13" rx="2"/><path d="M9 7V5a2 2 0 0 1 2-2h2a2 2 0 0 1 2 2v2"/><line x1="3" y1="13" x2="21" y2="13"/>'
    ),
    Layers: () => icon(
      '<polygon points="12 3 22 8 12 13 2 8 12 3"/><polyline points="2 13 12 18 22 13"/><polyline points="2 18 12 23 22 18"/>'
    ),
    Bell: () => icon(
      '<path d="M18 16V11a6 6 0 1 0-12 0v5l-2 3h16z"/><path d="M10 20a2 2 0 0 0 4 0"/>'
    ),
    Activity: () => icon('<polyline points="3 12 7 12 10 4 14 20 17 12 21 12"/>'),
    TrendingUp: () => icon(
      '<polyline points="3 17 9 11 13 15 21 7"/><polyline points="15 7 21 7 21 13"/>'
    ),
    Save: () => icon(
      '<path d="M5 4h11l3 3v13a1 1 0 0 1-1 1H5a1 1 0 0 1-1-1V5a1 1 0 0 1 1-1z"/><polyline points="7 4 7 10 15 10"/>'
    ),
    Cmd: () => icon(
      '<path d="M9 9V6.5a2.5 2.5 0 1 0-2.5 2.5H9zm0 0v6m0 0H6.5A2.5 2.5 0 1 0 9 17.5V15zm0 0h6m0 0V6.5a2.5 2.5 0 1 1 2.5 2.5H15zm0 0v6m0 0v2.5a2.5 2.5 0 1 0 2.5-2.5H15z"/>'
    ),
    Filter: () => icon('<polygon points="3 5 21 5 14 13 14 19 10 21 10 13 3 5"/>'),
    User: () => icon('<circle cx="12" cy="8" r="4"/><path d="M4 21a8 8 0 0 1 16 0"/>'),
    Sun: () => icon(
      '<circle cx="12" cy="12" r="4"/><line x1="12" y1="2" x2="12" y2="5"/><line x1="12" y1="19" x2="12" y2="22"/><line x1="2" y1="12" x2="5" y2="12"/><line x1="19" y1="12" x2="22" y2="12"/><line x1="5" y1="5" x2="7" y2="7"/><line x1="17" y1="17" x2="19" y2="19"/><line x1="5" y1="19" x2="7" y2="17"/><line x1="17" y1="7" x2="19" y2="5"/>'
    ),
    Wifi: () => icon(
      '<path d="M2 9a16 16 0 0 1 20 0"/><path d="M5 12.5a11 11 0 0 1 14 0"/><path d="M8.5 16a6 6 0 0 1 7 0"/><circle cx="12" cy="19.5" r="1"/>'
    ),
    Battery: () => icon(
      '<rect x="2" y="8" width="18" height="8" rx="1.5"/><rect x="3.5" y="9.5" width="13" height="5" rx="0.5" fill="currentColor" stroke="none"/><line x1="22" y1="11" x2="22" y2="13"/>'
    ),
    Signal: () => icon(
      '<rect x="3" y="15" width="3" height="5" fill="currentColor" stroke="none"/><rect x="9" y="11" width="3" height="9" fill="currentColor" stroke="none"/><rect x="15" y="7" width="3" height="13" fill="currentColor" stroke="none"/><rect x="20" y="3" width="3" height="17" fill="currentColor" stroke="none" opacity="0.35"/>'
    ),
  };

  /* Map brand marks (Apple Maps, Google Maps, Waze) — generan HTML inline */
  const BrandMarks = {
    AppleMaps: (size = 44) => `
    ...
    GoogleMaps: (size = 44) => `
      <div class="brand-mark" style="width:${size}px;height:${size}px;border-radius:10px;background:#fff;border:1px solid #e3e6ea;display:flex;align-items:center;justify-content:center;position:relative;overflow:hidden;">
        ...
        <svg width="${size * 0.55}" height="${size * 0.55}" viewBox="0 0 24 24" fill="none" style="position:relative;">
