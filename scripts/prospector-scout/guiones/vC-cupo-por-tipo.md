...
**Antes de escribir el informe, PARA y cuenta lo que tienes por tipo.** Cupo mínimo por provincia:

| Tipo | Mínimo | Por qué |
|---|---|---|
| **AAPP / CICA** (diputación, organismo del agua, mancomunidades, operador de la capital, ayuntamientos con red propia) | **3** | Es quien licita el volumen de red. Es el tipo que más se olvida y el que más tubo mueve |
| **CCRR** comunidades de regantes y sus juntas centrales | **3** | Universo finito y censable: no hay excusa para traer una sola |
| **ING** ingeniería (hidráulica, obra civil, regadíos, instalaciones) | **3** | Son quienes REDACTAN, o sea quienes escriben la marca en el pliego |
| **ARQ** arquitectura | **hasta 6** | ⚠️ Es un TECHO, no un objetivo. Pasado el 40% de la lista, deja de buscar arquitectura y busca lo que falta |
| **OCV** promotora / constructora / contratista | **2** | |
| **Distribución / canal** | **1** | Sin almacén con stock, la prescripción no se cobra |

**Si algún tipo está por debajo de su mínimo, NO escribas todavía el informe.** Vuelve a buscar dirigido a ese tipo concreto, con consultas específicas de ese tipo, y solo entonces cierra.

**Y hazte estas cuatro preguntas por escrito antes de cerrar** (van al informe, en «Pendientes de verificar»):
1. ¿He mirado las **mancomunidades y comarcas de agua** de esta provincia, por su nombre? Se han dado por inexistentes dos veces y sí existían, una de más de 55.000 habitantes.
2. ¿Quién **redacta** los proyectos que he citado? Si no tengo el nombre, ¿lo he buscado o solo lo he marcado como pendiente?
3. ¿Qué tipo de cliente de la tabla de arriba **no aparece en mi lista**, y es porque no existe en esta provincia o porque no lo he buscado? Responde con una de las dos cosas, no con silencio.
4. Si tuviera que hacer un segundo barrido de esta misma provincia, **¿por dónde empezaría?** Escríbelo: es lo que más ayuda a quien lo retome.
